...
import { SceneFacade, AssetsApi, TurnsApi } from './SceneFacade';
import { EntityFacade } from './EntityFacade';
import { ElementHandle } from '../entity/components/ElementHandle';
import {
  EditorGame,
  EditorSceneFacade,
  EditorEntityFacade,
...
type _ElementCompat = Expect<RuntimeKeys<InstanceType<typeof ElementHandle>> extends keyof EditorElementHandle ? true : false>;
type _TurnsCompat  = Expect<RuntimeKeys<InstanceType<typeof TurnsApi>>      extends keyof EditorTurnsApi      ? true : false>;
...
describe('script-globals drift', () => {
  test('runtime classes assign to editor-facing types', () => {
    ...
    void ({} as _ElementCompat);
    void ({} as _TurnsCompat);
